...
NEXT_PUBLIC_STRIPE_ESSENTIAL_MONTHLY=price_...
NEXT_PUBLIC_STRIPE_ESSENTIAL_YEARLY=price_...
NEXT_PUBLIC_STRIPE_PRO_MONTHLY=price_...
NEXT_PUBLIC_STRIPE_PRO_YEARLY=price_...

# Credit Packs
NEXT_PUBLIC_STRIPE_CREDITS_20=price_...
NEXT_PUBLIC_STRIPE_CREDITS_100=price_...
NEXT_PUBLIC_STRIPE_CREDITS_300=price_...
...
2. Add each `NEXT_PUBLIC_STRIPE_*` variable
3. Make sure `STRIPE_SECRET_KEY` is already set
4. Set `NEXT_PUBLIC_BASE_URL=https://your-domain.com`
5. Redeploy
