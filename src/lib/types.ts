...
export const ProgramSchema = z.object({
  ...
  work_experience_required: z.union([z.string(), z.boolean()]).optional(),
  is_elearning: z.boolean().optional(),
  is_complete_online_possible: z.boolean().optional(),
  financial_support: z.string().optional(),
  ects_credits: z.string().optional(),
...
export const SearchFiltersSchema = z.object({
  ...
  scholarship_available: z.boolean().optional(),
  requires_english_proof: z.boolean().optional(),
  requires_german_proof: z.boolean().optional(),
  max_ielts_score: z.number().optional(),
  max_toefl_score: z.number().optional(),
  max_minimum_gpa: z.number().optional(),
  requires_work_experience: z.boolean().optional(),
  max_min_ects: z.number().optional(),
  deadline_after: z.string().optional(),
  application_channel: z.string().optional(),
  max_semester_fee: z.number().optional(),
  max_living_expenses: z.number().optional(),
