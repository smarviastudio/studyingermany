...
export class CSVLoader {
  ...
  private normalizeRow(row: RawCSVRow): Program {
    ...
    const program: Program = {
      ...
      minimum_gpa: row.minimum_gpa || undefined,
      work_experience_required: parseBoolean(row.work_experience_required),
      is_elearning: parseBoolean(row.is_elearning),
      is_complete_online_possible: parseBoolean(row.is_complete_online_possible),
      financial_support: row.financial_support || undefined,
