      ...
      <main style={{ paddingTop: 80 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, maxWidth: 1200, margin: '0 auto' }}>
            ...
            <div style={{ background: '#fff', border: '1.5px solid #e5e5e5', borderRadius: 20, padding: 32, display: 'flex', flexDirection: 'column' }}>
              ...
              <button
                onClick={() => handleCheckout(
                  billingPeriod === 'monthly' 
                    ? process.env.NEXT_PUBLIC_STRIPE_ESSENTIAL_MONTHLY || '' 
                    : process.env.NEXT_PUBLIC_STRIPE_ESSENTIAL_YEARLY || '',
                  'subscription'
                )}
                disabled={loading !== null}
                style={{
        ...
        <section style={{ maxWidth: 1000, margin: '0 auto', padding: '0 24px 80px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: 24, maxWidth: 900, margin: '0 auto' }}>
            {[
              { credits: 20, price: 2.99, priceId: process.env.NEXT_PUBLIC_STRIPE_CREDITS_20, perCredit: 0.15, label: 'Best for trying' },
              { credits: 100, price: 9.99, priceId: process.env.NEXT_PUBLIC_STRIPE_CREDITS_100, perCredit: 0.10, label: 'Most popular', popular: true },
              { credits: 300, price: 24.99, priceId: process.env.NEXT_PUBLIC_STRIPE_CREDITS_300, perCredit: 0.08, label: 'Best value 🔥', badge: true },
            ].map((pack) => (
              <div
                key={pack.credits}
                style={{
